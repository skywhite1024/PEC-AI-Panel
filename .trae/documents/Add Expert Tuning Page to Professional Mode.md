I will add the "Expert Tuning" (专家调参) page to the Professional Mode.
...
2.  **Modify `components/ProfessionalPanel.tsx`**:
    ...
    *   Add the "专家调参" button in the tab navigation bar next to "实时计算".
    *   Render the `ExpertTuningPanel` when the "专家调参" tab is active.
